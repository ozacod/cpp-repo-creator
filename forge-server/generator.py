...
def generate_dependencies_cmake(
    libraries_with_options: List[Tuple[Library, Dict[str, Any]]],
    include_tests: bool = True,
    testing_framework: str = "googletest",
) -> str:
    """Generate the .cmake/forge/dependencies.cmake content.
    
    This file contains all FetchContent declarations and can be regenerated
    ...
    Returns:
        Generated dependencies.cmake content.
    """
...
"""
    ...
    if main_libraries:
        cmake_content += "# -----------------------------------------------------------------------------\n"
        cmake_content += "# Main Dependencies\n"
        cmake_content += "# -----------------------------------------------------------------------------\n\n"
    ...
    if include_tests and test_libraries:
        cmake_content += "# -----------------------------------------------------------------------------\n"
        cmake_content += "# Test Dependencies\n"
        cmake_content += "# -----------------------------------------------------------------------------\n\n"
...
def create_project_zip(
    ...
    with zipfile.ZipFile(zip_buffer, 'w', zipfile.ZIP_DEFLATED) as zf:
        ...
        zf.writestr(
            f"{prefix}.cmake/forge/dependencies.cmake",
            generate_dependencies_cmake(libraries_with_options, include_tests, testing_framework)
        )
