    ...
    <div className="space-y-12">
      ...
      <div className="text-center space-y-6 animate-fade-in">
        ...
        <div className="flex justify-center">
          <svg className="w-28 h-28" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            {/* Background */}
            <rect width="64" height="64" rx="12" fill="url(#bgGradHero)"/>
            {/* Hammer */}
            <g transform="translate(6, 4) scale(0.45)">
              <path fill="#f59e0b" d="M45.2,23.6l-5.1,5.1L27.9,16.6l5.1-5.1c1.4-1.4,3.6-1.4,5,0l7.2,7.2C46.6,20,46.6,22.2,45.2,23.6z"/>
              <path fill="#fbbf24" d="M40.1,28.7l-5.1,5.1L22.8,21.7l5.1-5.1L40.1,28.7z"/>
              <path fill="#92400e" d="M35,33.8L21.7,47.1c-0.8,0.8-2,0.8-2.8,0l-4.2-4.2c-0.8-0.8-0.8-2,0-2.8L28,26.8L35,33.8z"/>
              <path fill="#78350f" d="M28,26.8l-13.3,13.3c-0.8,0.8-0.8,2,0,2.8l1.4,1.4l14.7-14.7L28,26.8z"/>
            </g>
            {/* C++ Logo */}
            <g transform="translate(28, 28) scale(0.105)">
