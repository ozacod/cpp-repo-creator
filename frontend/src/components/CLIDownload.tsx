    ...
    <div className="max-w-4xl mx-auto px-4">
      ...
      <div className="flex items-center gap-6 mb-6">
        <div className="w-20 h-20 rounded-2xl bg-gray-900/80 border border-white/10 flex items-center justify-center">
          <img src="/forge.svg" alt="Forge" className="w-14 h-14" />
        </div>
        <div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-gray-900/50 border border-white/10 rounded-xl p-4">
          ...
          <a 
            ...
            className="block text-center text-xs text-gray-500 hover:text-cyan-400 mt-2"
          >
            Binary only →
          </a>
        </div>
        ...
        <div className="bg-gray-900/50 border border-white/10 rounded-xl p-4">
          ...
          <a
            href={`${BASE_URL}/forge-windows-amd64.exe`}
            className="flex items-center justify-center gap-2 w-full py-2 bg-cyan-500 hover:bg-cyan-400 text-black text-sm font-semibold rounded-lg transition-colors"
          >
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
      ...
      <p className="text-xs text-gray-500 text-center">
        <a href="https://github.com/ozacod/forge/blob/master/LICENSE" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300">MIT license</a>
        {' • '}
        <a href="https://github.com/ozacod/forge" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300">GitHub</a>
      </p>
    </div>
  );
}
